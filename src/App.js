...
import { AboutPage, AuthWrapper, CartPage, CheckoutPage, ErrorPage, Home, PrivateRoute, ProductsPage, SingleProductPage }
  from "./pages"
...
function App() {
  return (
    <Router>
      ...
      <Sidebar />
      <Switch>
        <Route exact path="/">      <Home />      </Route>  {/*зарезервировали адрес / за компонентом Home*/}
