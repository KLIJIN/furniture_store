...
const Sort = () => {
  ...
  return <Wrapper>
    <div className="btn-container">
      <button type="button" > <BsFillGridFill className={`${grid_view ? "active" : ""}`} onClick={setGridView} /> </button>
      <button type="button" > <BsList className={`${!grid_view ? "active" : ""}`} onClick={setListView} /> </button>
    </div>
